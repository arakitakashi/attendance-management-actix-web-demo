...
pub fn execute_clock_in(command: ClockInCommand) -> Result<ClockInEvent, AttendanceWorkflowError> {
    ...
    Ok(ClockInEvent::ClockInSucceeded { record})
}
...
mod tests {
    ...
    #[test]
    fn test_clock_in_workflow_succeeds_with_valid_command() {
        // Arrange
        ...
        // Act
        let result = execute_clock_in(command);
   ...
   #[test]
   fn test_clock_in_workflow_fails_with_empty_employee_id() {
       // Arrange
       let command = ClockInCommand {
